...
Это основной класс библиотеки. Возвращаемая `JsonNode` - это результат слияния всех документов из пула схем в одну. 
...
Наследник `GitReference`. Это отображение формата ссылок, используемых в [GitHub API](#-github).
